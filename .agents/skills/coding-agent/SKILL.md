...
#name: hotel-tajamonae-expert
#description: Lógica de negocio y reglas tributarias para el Hotel Tajamonae.

## 🏨 Infraestructura de Habitaciones
- **Bloque TJ1:** 12 habitaciones distribuidas en 2 pisos (6 por piso).
- **Bloque TJ2:** 8 habitaciones.
- **Estados Visuales:** 
  - Disponible: Verde (Success)
  - Ocupada: Rojo (Destructive)
  - En Limpieza: Amarillo (Warning)

## 💰 Reglas Tributarias y Precios
- **IVA (19%):** Aplicar estrictamente a servicios de **Hospedaje ($80,000)** y **Lavandería ($14,000)**.
- **Impoconsumo (8%):** Aplicar estrictamente a servicios de alimentación: **Desayuno/Cena ($27,000)** y **Almuerzo ($28,500)**.
- **Cálculo:** El agente debe generar funciones que calculen el subtotal, el impuesto correspondiente y el total final por operario.

## 👥 Gestión de Personal (Excel)
- **Agrupamiento Inteligente:** Al procesar archivos de MASA o INMEL, priorizar la asignación de operarios de la misma empresa en la misma habitación.
- **Campos Críticos:** nombre_completo, documento_identidad, rfid_uid, empresa (MASA, INMEL, MR ING).

## 🎨 Branding Corporativo
- **Primary Color:** #005d6a
- **Secondary Color:** #924b08